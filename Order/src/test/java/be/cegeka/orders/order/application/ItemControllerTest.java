...
public class ItemControllerTest {
    ...
    public void addItem_shouldGoToItemService() throws Exception {
        itemController.addItem("Nicky", "Is not really an item, Jerk", new BigDecimal(2.2));
        verify(itemService).addItem("Nicky", "Is not really an item, Jerk", new BigDecimal(2.2));
    }
}